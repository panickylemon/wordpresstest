...
<span class="description">
    ...
    <?php printf(
	    ...
	    'https://vk.com/apps?act=settings'
    ); ?>
    </span>
					<br/>
	        ...
	        ?></textarea>
					...
					<div>
						...
						<div>
							...
							<?php wp_dropdown_categories( array( 'name'  => 'vkapi_crosspost_category',
							                                     'class' => 'widefat'
							) ); ?>
						</div>
					</div>
                ...
                <span class="description">
					...
					<div class="info2">
                        ...
                        <span class="description">
							...
							<p>Плагин установлен на <?php echo get_option( 'vkapi__active_installs' ) ?><b>+</b> сайтах.
							</p>
						</div>
					</div>
				</div>
